...
const GAME_CATALOG: GameTile[] = [
  ...
  },
  {
    id: "crash",
    title: "Crash",
    subtitle: "Multiplayer · cash out before the bust",
    rtp: "99.00%",
    status: "soon",
    phase: "Phase 4.3",
    emoji: "↗",
...
type Tab = "lobby" | "blackjack" | "coinflip" | "dice" | "roulette" | "slots" | "roadmap" | "fairness";
    ...
    <div className="mt-8 space-y-8">
      ...
      <section>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
          {GAME_CATALOG.map((g) => {
            const route = g.id === "blackjack" || g.id === "coinflip" || g.id === "dice" || g.id === "roulette" || g.id === "slots" ? (g.id as Tab) : null;
            return (
            <div
              key={g.id}
              className={
