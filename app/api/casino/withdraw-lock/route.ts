...
import { serverLockWithdrawBalance } from "@/lib/casino/withdraw-lock";
...
export async function POST(req: Request) {
  ...
  const result = await serverLockWithdrawBalance(supabase, auth.userId, {
  ...
  return NextResponse.json({ locked: result.locked });
}
