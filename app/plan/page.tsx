...
const COMPLETED: CompletedItem[] = [
  ...
  { category: "Design & UX", title: "Homepage lacks call-to-action or navigation guidance", detail: "Added three CTA buttons below the hero: 'Get Started' (gold, links to /wallets), 'View Contracts' (outline, links to /contracts), and 'Learn More' (outline, links to /about). Uses Next.js Link for client-side navigation.", files: "app/page.tsx", priority: "medium" },
  ...
  { category: "Design & UX", title: "SEO description uses 'Hedge Fun' pun", detail: "Changed meta description in layout.tsx and page.tsx from 'Hedge Fun' to 'Hedge Fund' for search engine discoverability. The visible UI pun is preserved.", files: "layout.tsx, app/page.tsx", priority: "low" },
