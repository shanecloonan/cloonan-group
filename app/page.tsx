    ...
    <>
      ...
      <div className="relative flex flex-col items-center justify-center overflow-hidden py-20 sm:py-28">
        ...
        <div className="relative z-10 flex flex-col items-center px-6 text-center">
          <MoneyFundLogo className="w-48 h-48 sm:w-56 sm:h-56 md:w-64 md:h-64 mb-2" />

          <h1 className="font-heading text-[28px] sm:text-[36px] md:text-[44px] font-semibold tracking-[2px] text-white leading-tight mb-1.5">
