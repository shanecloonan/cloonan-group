...
## Allowlist a token (USDC, etc.)

```powershell
$env:CASINO_VAULT = "0xYourVault"
$env:ALLOW_TOKEN = "0xUSDCOnThisChain"
$env:DEPLOYER_KEY = "0x..."   # vault owner
$env:RPC_URL = "https://sepolia.base.org"
.\scripts\configure-casino-vault.ps1
```

Calls `setTokenAllowed(token, true)` on the deployed vault.
